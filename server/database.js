...
const {Pool, Client, defaults, QueryResult} = require("pg");
...
// const db = new Client('postgres://postgres:imran@localhost:5432/ifad');

// initializing connection pool according to the config setup
const pool = new Pool(config_connection);
