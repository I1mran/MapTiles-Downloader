...
const port_exp  = process.env.PORT;

//  PostGIS input_points_srid, output_geom_srid
const input_srid  = process.env.PGINSRID ;
const output_srid  = process.env.PGOUTSRID;

exports.config_db = { host, port, username, password, database, ssl, max_client, idleTimeoutMillis, connectionTimeoutMillis, };
exports.exp_config = { port_exp };
exports.config_pg = { input_srid, output_srid,};
